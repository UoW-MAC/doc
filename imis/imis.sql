...
--------------------------------------------------------
  ...
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" )  ENABLE;
  ALTER TABLE "IMIS"."POSITION" MODIFY ("POSITION_NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "IMIS"."ORGANIZATION" MODIFY ("ORGANIZATION_NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "IMIS"."POSITION_GROUP" MODIFY ("GROUP_NAME" NOT NULL ENABLE);
